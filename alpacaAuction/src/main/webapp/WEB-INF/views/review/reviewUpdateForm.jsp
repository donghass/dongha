...
<form action="reviewUpdate.do" name="myform" id="myform" method="post" enctype="multipart/form-data">
	...
	<div class="form-group"><label for="Title" class="col-xs-2 col-lg-2 control-label">제목</label><div class="col-xs-10 col-lg-10"><input required="required" type="text" class="form-control" name="title" autofocus="autofocus" value="${review_board.title }"></div></div>
